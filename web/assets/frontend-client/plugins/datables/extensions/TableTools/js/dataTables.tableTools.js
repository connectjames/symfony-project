...
/* TableTools
 * 2009-2014 SpryMedia Ltd - datables.net/license
 */
...
{
	alert( "Warning: TableTools requires DataTables 1.9.0 or newer - www.datables.net/download");
}
...
{
	alert( "Warning: TableTools 2 requires DataTables 1.9.0 or newer - www.datables.net/download");
}
